        ...
        <fieldset>
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="col-md-2 control-label" for="cpf">CPF <h11>*</h11>
                        </label>
                        <div class="col-md-2">
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label" for="NomeMae">Nome da Mãe <h11>*
                                </h11></label>
                            <div class="col-md-6">
                                <input id="NomeMae" name="NomeMae" placeholder="" class="form-control input-md"
                                    required="" type="text">
                            </div>
                        </div>

                        <label class="col-md-1 control-label" for="Datadenascimento">Nascimento<h11>*</h11>
                        </label>
                        <div class="col-md-2">
                            <input id="Datadenascimento" name="Datadenascimento" placeholder="DD/MM/AAAA" class="form-control input-md"
                                required="" type="text" maxlength="10" OnKeyPress="formatar('##/##/####', this)"
                                onBlur="showhide()">
                        </div>
                        <br />
                        <label class="col-md-1 control-label" for="sexo">Sexo <h11>*</h11>
                        </label>
                        <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                    <label class="input-group-addon" for="nacionalidade">Nacionalidade</label>
                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                    <label for="naturalidade" class="input-group-addon">Naturalidade</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
                                        <label for="Rua" class="input-group-addon">Rua</label>
                                        <input id="Rua" name="Endereco" placeholder="" class="form-control input-md"
                                            required="" type="text">
                                    </div>
                                    <br />
                                    <div class="input-group">
                                        <label for="Complemento" class="input-group-addon">Complemento</label>
                                ...
                                <div class="col-md-2">
                                    <div class="input-group">
                                        <label for="numero" class="input-group-addon">Nº <h11>*</h11></label>
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        ...
                                        <input id="Bairro" name="Bairro" placeholder="" class="form-control input-md"
                                            required="" type="text">
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
                                        ...
                                        <input id="Cidade" name="Cidade" placeholder="" class="form-control input-md"
                                            required="" type="text">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            ...
                                            <input id="filhos_qtd" name="filhos_qtd" class="form-control" type="text"
                                                placeholder="Quantos?" pattern="[0-9]+$">
